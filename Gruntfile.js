...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      autoprefixer: {
        files: ['<%= yeoman.app %>/public/css/**/*.css'],
      ...
      dist: {
        files: [{
          src: [
            ...
            '<%= yeoman.dist %>/public/fonts/**/*.{eot*,otf,svg,ttf,woff}'
          ]
        }]
      }
    },
